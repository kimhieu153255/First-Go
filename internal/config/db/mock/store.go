...
func (m *MockStore) SelectUser(arg0 context.Context, arg1 string) (db.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) SelectUser(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelectUser", reflect.TypeOf((*MockStore)(nil).SelectUser), arg0, arg1)
}
